...
export default function ConfirmationPage() {
    ...
    const email = user?.email || "メールアドレスが取得できませんでした。";
            ...
            <div className="min-h-screen flex flex-col">
                ...
                <main className="flex-1 flex flex-col items-center justify-center bg-gray-50 p-8">
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md text-center max-w-3xl w-full">
                        ...
                        {/* メールアドレス */}
                        <p className="text-lg text-black font-bold mb-6">{email}</p>
                        ...
                        {/* TOPページに戻るボタン */}
                        <button
                            onClick={() => router.push(`/exhibitor/exhibitions/${exhibitionId}/application`)}
